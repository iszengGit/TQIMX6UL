...
#define OCOTP_CFG3_SPEED_792HZ	2
#define OCOTP_CFG3_SPEED_900MHZ 3

// For IMX6SX/IMX6SDL/IMX6DQ
...
u32 get_cpu_speed_grade_hz(void)
{
	...
	if (is_cpu_type(MXC_CPU_MX6UL) || is_cpu_type(MXC_CPU_MX6ULL)) {
		...
		else if ((val == OCOTP_CFG3_SPEED_696MHZ) && is_cpu_type(MXC_CPU_MX6UL)){
			return 696000000;
		}
		else if ((val == OCOTP_CFG3_SPEED_792HZ) && is_cpu_type(MXC_CPU_MX6ULL)) //For ULL
		{
			return 792000000;
		}
		else if (val == OCOTP_CFG3_SPEED_900MHZ) //For ULL
		{
			return 900000000;
		}
		else
