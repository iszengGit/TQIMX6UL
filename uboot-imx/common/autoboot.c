...
void leds_on(int onoff)
{
#define GPIO_LED1 	IMX_GPIO_NR(5, 7)
#define GPIO_LED2	IMX_GPIO_NR(5, 2)
	if(onoff != 0) //on
	{
		gpio_direction_output(GPIO_LED1 , 1);
		gpio_direction_output(GPIO_LED2 , 1);
//		run_command("gpio set 130",0);
//		run_command("gpio set 135",0);
	}
	else
	{
		gpio_direction_output(GPIO_LED1 , 0);
		gpio_direction_output(GPIO_LED2 , 0);
//		run_command("gpio clr 135",0);
//		run_command("gpio clr 130",0);
