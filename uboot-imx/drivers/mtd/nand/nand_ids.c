...
struct nand_flash_dev nand_flash_ids[] = {
	...
	{"H27UCG8T2ATR-BC 64G 3.3V 8-bit",
		{ .id = {0xad, 0xde, 0x94, 0xda, 0x74, 0xc4} },
		  ...
		  4 },
        {"IS34ML02G084-TLL 256M 3.3V 8-bit",
                { .id = {0xc8, 0xda, 0x90, 0x95, 0x44, 0x7f, 0x7f, 0x7f} },
                  SZ_2K, SZ_256, SZ_128K, 0, 8, 64, NAND_ECC_INFO(1, SZ_512),},
        {"IS34ML02G081-TLL 256M 3.3V 8-bit",
                { .id = {0xc8, 0xda, 0x90, 0x95, 0x46, 0x7f, 0x7f, 0x7f} },
                  SZ_2K, SZ_256, SZ_128K, 0, 8, 64, NAND_ECC_INFO(1, SZ_512),},
        {"IS34ML04G084-TLI 512M 3.3V 8-bit",
                { .id = {0xc8, 0xdc, 0x90, 0x95, 0x54, 0x7f, 0x7f, 0x7f} },
                  SZ_2K, SZ_512, SZ_128K, 0, 8, 64, NAND_ECC_INFO(4, SZ_512),},
        {"IS34ML04G081-TLI 512M 3.3V 8-bit",
                { .id = {0xc8, 0xdc, 0x90, 0x95, 0x56, 0x7f, 0x7f, 0x7f} },
                  SZ_2K, SZ_512, SZ_128K, 0, 8, 64, NAND_ECC_INFO(1, SZ_512),},
