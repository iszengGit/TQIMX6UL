...
#define CONFIG_MFG_ENV_SETTINGS_JK \
                ENV_NET \
                ENV_LOGO \
                ENV_IMG_NAME \
            "mtdparts=" MTDPARTS_DEFAULT "\0"\
            "mtdids=" MTDIDS_DEFAULT "\0"\
            "autodownload_sd="AUTO_DOWN_FROME_SDCARD"\0"\
        "defroot=root_nand\0"\
        "boot_args="\
        "if test ${defroot} = root_mmc;then "\
                "echo use mmcboot;"\
                "setenv bootargs console=${console},${baudrate} panel=${panel} "\
        ...
        "else "\
                ...
                "fi;"\
        "fi;\0"\
        "loadkernel_nand=nand read.e ${loadaddr} kernel;\0"\
...
#define CONFIG_SYS_MMC_ENV_DEV          0   /* USDHC1 ,1 means sdhc2*/
...
#define CONFIG_SYS_PROMPT "TQIMX6ULL => "
