...
#define CONFIG_TQ_SD_DOWNLOAD_DEV       0
#define CONFIG_TQ_SD_DOWNLOAD_PART      0
...
#define DTB_NAME        "tq-imx6ull.dtb"
...
#define ENV_NET \
                ...
                "nfs_dir=/opt/EmbedSky/nfs/imx6ull/rootfs\0"
...
#define CONFIG_SYS_LOAD_ADDR        CONFIG_LOADADDR  //0x80800000
#define CONFIG_SYS_HZ           1000

#define CONFIG_STACKSIZE        SZ_128K

#define CFG_FASTBOOT_TRANSFER_BUFFER  (CONFIG_SYS_MEMTEST_START + 32*1024*1024)
...
/*内核分区大小与kimagesize大小一致,分区名表在cmd_menu.c文件也会有用到，不建议修改 */
